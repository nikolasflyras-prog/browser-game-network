...
echo "SEO smoke test passed: public sitemap, robots rules, canonicals, conservative security headers, game structured data, trust/legal pages, footer launch navigation, and diagnostic noindex are all present."
