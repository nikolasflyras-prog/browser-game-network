...
export const gameRegistry: readonly GameMetadata[] = [
  ...
  { slug: "hedge-fund-floor", title: "Hedge Fund HQ", description: "Run a walkable long/short investment office across changing fund mandates: research companies, build and hedge a portfolio, hire a team, react to live markets, manage LP confidence, and adapt your risk budget to momentum, market-neutral, preservation, and macro-whipsaw regimes.", lane: "Learn", category: "Portfolio Management", status: "live", version: "0.2.0" },
  ...
  { slug: "fab-floor", title: "Fab Floor", description: "Run a walkable semiconductor manufacturing business: release wafer lots, manage bottlenecks and tool alarms, win customer orders against yield and deadline targets, invest in lithography/etch/metrology capex, hire equipment technicians, and advance from mature-node production toward leading-edge process programs.", lane: "Learn", category: "Wafer Fab Operations", status: "live", version: "0.2.0", collection: "Semiconductors" },
