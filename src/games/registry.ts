...
export const gameRegistry: readonly GameMetadata[] = [
  ...
  { slug: "hedge-fund-floor", title: "Hedge Fund HQ", description: "Run a walkable long/short investment office: develop company theses, build and hedge a portfolio, hire analysts, traders, and risk staff, react to live news, manage operating budget, and protect NAV and LP confidence.", lane: "Learn", category: "Portfolio Management", status: "live", version: "0.1.0" },
