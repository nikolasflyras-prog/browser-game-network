  ...
  return (
    <article className="game-page">
      <header className="game-heading">
        <p className="eyebrow">{game.lane} · {game.category}</p>
        <h1>{game.title}</h1>
      ...
      <section className="content-section">
        ...
        <p>
          {isOrbitRelay
            ...
            : "The diagnostic scene is an engineering surface. It validates lazy Phaser loading, responsive canvas behavior, input mapping, lifecycle cleanup, local persistence, and gameplay analytics without spending time on production art."}
        </p>
      </section>
