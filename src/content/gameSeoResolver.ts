...
import { getSemiconductorVcDepthSeoContent } from "./gameSeoSemiconductorVcDepth";
import { getFabFloorBusinessSeoContent } from "./gameSeoFabFloorBusiness";
...
export function getAnyGameSeoContent(slug: string): GameSeoContent | undefined {
  return getFinanceRebuildSeoContent(slug)
    ?? getSemiconductorVcDepthSeoContent(slug)
    ?? getFabFloorBusinessSeoContent(slug)
